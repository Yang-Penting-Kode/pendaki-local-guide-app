                  ...
                  Container(
                    ...
                    child: const ClipOval(
                      child: CustomNetworkImage(
                        imageUrl:
                            'https://picsum.photos/seed/ruy7vg/600/400',
                      ),
                    ),
                  ),
            ...
            GridView.count(
              ...
              children: [
                _buildProductCard(context, 'Tenda Eiger 4P', '50.000', '3',
                    'https://picsum.photos/seed/it19pj/600/400'),
                _buildProductCard(
                    context,
                    'Tenda Consina Magnum 4',
                    '45.000',
                    '1',
                    'https://picsum.photos/seed/s9mbn2/600/400'),
                _buildProductCard(
                    context,
                    'Tenda Great Outdoor 6P',
                    '75.000',
                    '5',
                    'https://picsum.photos/seed/g7ai4g/600/400'),
                _buildProductCard(
                    context,
                    'Tenda Naturehike Cloud Up 2',
                    '60.000',
                    '2',
                    'https://picsum.photos/seed/hy8ji7/600/400'),
              ],
            ),
          ],
        ),
