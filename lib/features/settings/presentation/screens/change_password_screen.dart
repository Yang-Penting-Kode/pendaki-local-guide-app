          ...
          child: Container(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                ...
                final storedPwd = StorageService.getRegisteredPassword();
                ...
                if (newPwd.length < 8) {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Kata sandi baru minimal 8 karakter!'), backgroundColor: Colors.red));
                  return;
                }
                
                final email = StorageService.getRegisteredEmail() ?? '';
                StorageService.setRegisteredCredentials(email, newPwd);
